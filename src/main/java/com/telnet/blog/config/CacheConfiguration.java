package com.telnet.blog.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BlogMicroservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BlogMicroservice");
        ...
        config.getMapConfigs().put("com.telnet.blog.domain.*", initializeDomainMapConfig(jHipsterProperties));
